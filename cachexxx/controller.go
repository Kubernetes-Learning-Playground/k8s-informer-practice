...
// and put into the controller cachexxx and before the corresponding handlers will
// be called on it.
// TransformFunc (similarly to ResourceEventHandler functions) should be able
// to correctly handle the tombstone of type cachexxx.DeletedFinalStateUnknown
//
