...
// Get returns unexpired items. It purges the cachexxx of expired items in the
// process.
...
// List retrieves a list of unexpired items. It purges the cachexxx of expired
...
// ListKeys returns a list of all keys in the expiration cachexxx.
func (c *ExpirationCache) ListKeys() []string {
	return c.cacheStorage.ListKeys()
}

// Add timestamps an item and inserts it into the cachexxx, overwriting entries
...
// Delete removes an item from the cachexxx.
