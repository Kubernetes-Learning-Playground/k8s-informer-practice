...
// and put into the controller cache_copy and before the corresponding handlers will
// be called on it.
// TransformFunc (similarly to ResourceEventHandler functions) should be able
// to correctly handle the tombstone of type cache_copy.DeletedFinalStateUnknown
//
