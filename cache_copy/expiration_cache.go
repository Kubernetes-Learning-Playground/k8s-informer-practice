...
// Get returns unexpired items. It purges the cache_copy of expired items in the
// process.
...
// List retrieves a list of unexpired items. It purges the cache_copy of expired
...
// ListKeys returns a list of all keys in the expiration cache_copy.
func (c *ExpirationCache) ListKeys() []string {
	return c.cacheStorage.ListKeys()
}

// Add timestamps an item and inserts it into the cache_copy, overwriting entries
...
// Delete removes an item from the cache_copy.
