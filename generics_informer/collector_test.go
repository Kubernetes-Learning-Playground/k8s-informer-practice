...
func TestGenericsCollectorWithConfig(t *testing.T) {
	gc, err := NewGenericsCollectorWithConfig(
		"./config.yaml",
...
func TestGenericsCollectorWithGVR(t *testing.T) {
	gc, err := NewGenericsCollectorWithGVR(
		option.NewCollectorOption(5, 0),
		config.InitClientOrDie(),
		"apps/v1/deployments",
		"core/v1/pods",
